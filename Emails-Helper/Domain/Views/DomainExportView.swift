...
//
////
////struct RequestAmountField: Identifiable {
////    let id = UUID()
...
////    @Published var amountFields: [RequestAmountField]
////   
////    let domain : Domain
////    
////    
////    init(domain: Domain) {
////        self.domain = domain
////        self.amountFields = domain.importNames.map {
////            RequestAmountField(importName: $0, amount: "")
////        }
////    }
////}
//////    func save() {
...
////    init(domain:Domain){
////        self.domain = domain
////        _requestViewModel = StateObject(wrappedValue: RequestViewModel(domain: domain))
////        
////    }
//    
//    
